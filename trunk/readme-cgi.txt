...
This is the README for the CGI version of the Media script.
I recommend that you use the included PHP version instead.
If you want to use the PHP version, you should be reading readme-php.txt
...
A) The MEDIA.CGI file

   #!/usr/bin/perl            - Edit this line only in the MEDIA.CGI
                                file. This line is the location of perl
                                on your webserver. You may need to ask
                                your webspace provider where this is
                                located.
...
E) Your page
   ...
   would now be
   http://www.server.com/~yoursite/media.cgi?greenday
